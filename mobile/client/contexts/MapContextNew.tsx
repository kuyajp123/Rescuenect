...
import { useMapButtonStore } from '@/components/components/Map/MapNew';
...
export const MapContextNew = ({ children }: MapProviderProps) => {
  ...
  const toggleMapStyles = useCallback(() => {
    ...
    const handlePress = useCallback((event: any) => {
      ...
      const markerCoordinate: [number, number] = [coords[0], coords[1]];
