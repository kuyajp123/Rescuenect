...
export const handleGoogleSignIn = async (setLoading?: (loading: boolean) => void) => {
  try {
    ...
    const nextUserData = {
      ...
      clientStatus: responseUser.clientStatus ?? userData.clientStatus ?? null,
      clientDeletionEffectiveAt: responseUser.clientDeletionEffectiveAt ?? userData.clientDeletionEffectiveAt ?? null,
      clientDeletionStatus: responseUser.clientDeletionStatus ?? userData.clientDeletionStatus ?? null,
