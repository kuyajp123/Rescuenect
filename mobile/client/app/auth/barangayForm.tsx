    ...
    <Body style={styles.body}>
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.description} emphasis="light">
          We collect your barangay information to accurately provide
          location-based disaster updates, coordinate assistance, and ensure the
          accuracy of information we will provide.
        </Text>
      </View>
