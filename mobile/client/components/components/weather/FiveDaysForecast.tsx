...
export const FiveDaysForecast = ({ day, date, weatherCode, temperature, onPress }: FiveDaysForecastProps) => {
    ...
    <Pressable onPress={onPress}>
      <View style={styles.forecastContainer}>
        <View style={styles.dayDateContainer}>
          <Text emphasis="light" style={styles.dayText}>
            {day}
          </Text>
          <Text size="2xs" bold style={styles.dateText}>
            {date}
          </Text>
        </View>
        <View>
        ...
        <View>
          <Text size="lg" bold style={styles.temperatureText}>
            {temperature}
          </Text>
        </View>
      </View>
