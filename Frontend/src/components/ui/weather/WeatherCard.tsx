    ...
    <Card>
          <CardBody className="flex flex-row gap-4">
            ...
            <div >
              <Table 
              shadow="none" 
              hideHeader aria-label="Example static collection table"
              >
                <TableHeader>
                ...
                <TableBody>
                  <TableRow key="1">
                    ...
                    <TableCell><p>{temperatureApparent}</p></TableCell>
