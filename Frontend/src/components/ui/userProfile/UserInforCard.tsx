        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
            ...
            <div>
              ...
              <p className="text-sm font-medium text-gray-800 dark:text-white/90">Rescuenect Administrator</p>
            </div>
          </div>
        </div>
                    ...
                    <div className="mt-7">
                      ...
                      <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                        <div className="col-span-2 lg:col-span-1">
                          ...
                          <Input type="text" variant="bordered" value="Musharof" />
                        </div>

                        <div className="col-span-2 lg:col-span-1">
                          <Label>Last Name</Label>
                          <Input type="text" variant="bordered" value="Chowdhury" />
                        </div>

                        <div className="col-span-2 lg:col-span-1">
                          <Label>Phone</Label>
                          <Input type="text" variant="bordered" value="+09 363 398 46" />
                        </div>

                        <div className="col-span-2">
                          <Label>Bio</Label>
                          <Input type="text" variant="bordered" value="Rescuenect Administrator" />
                        </div>
                      </div>
                    </div>
                  </div>
